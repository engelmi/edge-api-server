...
import (
	...
	scheme "github.com/engelmi/edge-api-server/pkg/generated/clientset/versioned/scheme"
...
type EdgeDeviceInterface interface {
	...
	Apply(ctx context.Context, edgeDevice *edgev1alpha1.EdgeDeviceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.EdgeDevice, err error)
	ApplyStatus(ctx context.Context, edgeDevice *edgev1alpha1.EdgeDeviceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.EdgeDevice, err error)
	EdgeDeviceExpansion
}
...
func newEdgeDevices(c *EdgeV1alpha1Client, namespace string) *edgeDevices {
	return &edgeDevices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *edgeDevices) Apply(ctx context.Context, edgeDevice *edgev1alpha1.EdgeDeviceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.EdgeDevice, err error) {
	if edgeDevice == nil {
...
func (c *edgeDevices) ApplyStatus(ctx context.Context, edgeDevice *edgev1alpha1.EdgeDeviceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.EdgeDevice, err error) {
	if edgeDevice == nil {
		return nil, fmt.Errorf("edgeDevice provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
