...
func main() {
	...
	flag.StringVar(&probeAddr, "health-probe-bind-address", ":9444", "The address the probe endpoint binds to.")
	...
	if err = (&edgecontrollers.EdgeDeviceReconciler{
